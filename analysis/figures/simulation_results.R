...
##### Nonlinear Analysis #####
sigma <- 1
nonlinear_sim1 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='nonlinear_poly',  rho = 0.5, sigma_eps = sigma,
                            write = TRUE, output = result_path, name = 'nonlinear_sim100_par_combo1_sigma1')

sigma <- 0.1
nonlinear_sim2 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='nonlinear_poly',  rho = 0.5, sigma_eps = sigma,
                            write = TRUE, output = result_path, name = 'nonlinear_sim100_par_combo2_sigma0.1')

sigma <- 0.01
nonlinear_sim3 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='nonlinear_poly',  rho = 0.5, sigma_eps = sigma,
                            write = TRUE, output = result_path, name = 'nonlinear_sim100_par_combo3_sigma0.01')

##### Correlated effect Analysis #####
sigma <- 1
correlated_sim1 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='correlated',  rho = 0.5, sigma_eps = sigma,
                                  write = TRUE, output = result_path, name = 'correlated_sim100_par_combo1_sigma1')

sigma <- 0.1
correlated_sim2 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='correlated',  rho = 0.5, sigma_eps = sigma,
                                  write = TRUE, output = result_path, name = 'correlated_sim100_par_combo2_sigma0.1')

sigma <- 0.01
correlated_sim3 <- pheno_corr_sims(100, all_n_ind, all_n_var, c=NULL, all_r, all_pi, sigma, mle = FALSE, null=FALSE, mode='correlated',  rho = 0.5, sigma_eps = sigma,
                                  write = TRUE, output = result_path, name = 'correlated_sim100_par_combo3_sigma0.01')
