...
p2 <- ggplot_pdf(image_read(paste0(figure_path, 'figureS16/ukb_pleiotropy_ALPL_variants.7YIV.by_phe_p0.05_exl.colored.png')))+
  theme(plot.margin = unit(c(0.5,0,0,0), "cm"))
p3 <- ggplot_pdf(image_read(paste0(figure_path, 'figureS16/ukb_pleiotropy_ALPL_variants.7YIV.by_phe_betasign_exl.colored.png')))+
  theme(plot.margin = unit(c(0.5,0,0,0), "cm"))
...
png(paste0(figure_path,'figureS16.png'), height = 6, width = 7.5, units = 'in', res = 300)
print(figure)
dev.off()
