...
leave_one_out_results <- read_csv(paste0('~/Desktop/ALLSPICE/ALLSPICE_leave_one_out_1e-4_example_ALB_results.csv'))
...
png(paste0(figure_path,'figureS14.png'), height = 5, width = 8, units = 'in', res = 300)
print(figure)
dev.off()
