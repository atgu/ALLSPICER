...
null_mle_sim_p11 <- save_null_sim_figures(null_mle_sim11 %>% dplyr::filter(pi == 0.5), pi_value = 0.5, name = 'figure1', save = T)
null_mle_sim_p11 <- save_null_sim_figures(null_mle_sim11 %>% dplyr::filter(pi == 0.8), pi_value = 0.8, name = 'figureS3', save = T)

null_mle_sim12 <- read_csv(paste0(result_path, 'null_mle_sim100_par_combo2_sigma0.1_test_results.csv'))
null_mle_sim_p12 <- save_null_sim_figures(null_mle_sim12 %>% dplyr::filter(pi == 0.5), pi_value = 0.5, name = 'figureS1', save = T)
null_mle_sim_p12 <- save_null_sim_figures(null_mle_sim12 %>% dplyr::filter(pi == 0.8), pi_value = 0.8, name = 'figureS4', save = T)

null_mle_sim13 <- read_csv(paste0(result_path, 'null_mle_sim100_par_combo3_sigma0.01_test_results.csv'))
null_mle_sim_p13 <- save_null_sim_figures(null_mle_sim13 %>% dplyr::filter(pi == 0.5), pi_value = 0.5, name = 'figureS2', save = T)
null_mle_sim_p13 <- save_null_sim_figures(null_mle_sim13 %>% dplyr::filter(pi == 0.8), pi_value = 0.8, name = 'figureS5', save = T)
...
figure = ggpubr::ggarrange(
  save_alt_sim_figure(alt_sim, name = 'figure2A', save = F) +
    guides(colour = guide_legend(nrow = 2, byrow = TRUE)) +
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(correlated_sim, name = 'figure2B', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(nonlinear_sim, name = 'figure2C', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
...
png(paste0(figure_path,'figure2.png'), height = 8, width = 7.5, units = 'in', res = 300)
print(figure)
dev.off()
...
figure = ggpubr::ggarrange(
  save_alt_sim_figure(alt_sim, name = 'figureS6A', save = F) +
    guides(colour = guide_legend(nrow = 2, byrow = TRUE)) +
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(correlated_sim, name = 'figureS6B', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(nonlinear_sim, name = 'figureS6C', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  ncol=1, font.label = list(size = 10, color = "black", face = "bold", family = 'Arial'), common.legend = T,
  labels = c('(A) Independent effect sizes',
             '(B) Correlated effect sizes',
...
png(paste0(figure_path,'figureS6.png'), height = 8, width = 7.5, units = 'in', res = 300)
print(figure)
dev.off()
...
figure = ggpubr::ggarrange(
  save_alt_sim_figure(alt_sim, name = 'figureS7A', save = F) +
    guides(colour = guide_legend(nrow = 2, byrow = TRUE)) +
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(correlated_sim, name = 'figureS7B', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  save_alt_sim_figure(nonlinear_sim, name = 'figureS7C', save = F)+
    theme(plot.margin = unit(c(0.5, 0, 0.5, 0), 'cm')),
  ncol=1, font.label = list(size = 10, color = "black", face = "bold", family = 'Arial'), common.legend = T,
  labels = c('(A) Independent effect sizes',
             '(B) Correlated effect sizes',
...
png(paste0(figure_path,'figureS7.png'), height = 8, width = 7.5, units = 'in', res = 300)
print(figure)
dev.off()
